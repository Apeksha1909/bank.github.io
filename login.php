...
<head>
    ...
    define('bankName', 'Sparks Project: Bank');
...
<h1 class="alert alert-success rounded-0"><?php echo bankName; ?><small class="float-right text-muted" style="font-size: 12pt;"><kbd>Made by:Apeksha Mahajan</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
<div id="accordion" role="tablist" class="w-25 float-right shadowBlack" style="margin-right: 440px">
	<br><h4 class="text-center text-black">Select Your Type</h4>
