...
<div class="row w-100" >
  ...
  <h4 class="display-5">Welecome to Bank</h4>
...
<div class="col">
    <div class="row" style="padding: 22px;padding-top: 0">
      <div class="col">
        <div class="card shadowBlack ">
          <div class="card-img-top" style="background:#008080;max-height: 155px;min-height: 155px" alt="Card image cap">  
          </div>
          <div class="card-body">
      ...
      <div class="col">
        <div class="card shadowBlack ">
          <div class="card-img-top" alt="Card image cap" style="background:#008080;max-height: 155px;min-height: 155px"></div>
        <div class="card-body">
    ...
    <div class="row" style="padding: 22px">
      <div class="col">
        <div class="card shadowBlack ">
          <div class="card-img-top" style="max-height: 155px;min-height: 155px;background:#008080" alt="Card image cap"></div>
          <div class="card-body">
